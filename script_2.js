...
const germanCarsArr = arrayCars.filter(car => germanCars.includes(car.car) || germanCars.includes(car.name))

const japanCarsArr = arrayCars.filter(car => japanCars.includes(car.car) || japanCars.includes(car.name))
